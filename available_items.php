...
<div id="available-items-panel" class="dashboard-view-panel" style="display: none;">
    <div class="glass-panel" style="padding: 30px; margin-bottom: 24px;">
        ...
        <div style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 20px;">
            ...
            <select class="form-control form-select" id="filterAvailableCategory" style="max-width: 220px;">
            ...
            <select class="form-control form-select" id="filterAvailableDistrict" style="max-width: 180px;">
