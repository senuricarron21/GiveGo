    ...
    <div class="dashboard-grid">
        ...
        <div class="glass-panel" style="padding: 30px; background: #FFFFFF;">
            ...
            <form id="formRequestMaterials">
                ...
                <!-- Common Title / Purpose -->
                <div class="grid-cols-2">
                    <div class="form-group">
                        <label class="form-label" id="lblReqItemName">Item / Task Title</label>
                        <input type="text" class="form-control" id="reqItemName" placeholder="e.g. Rice & Flour Packs / Garden Cleanup" required>
                    </div>
                    <div class="form-group">
                ...
                <!-- Physical Request Specific Fields -->
                ...
                <!-- Monetary Request Specific Fields -->
                <div id="secReqMonetary" style="display: none;">
                    ...
                    <div class="glass-panel" style="padding: 16px; margin-bottom: 20px; background: #FBF5DD; border: 1px solid var(--color-border-dark);">
                        ...
                        <div id="recBankDetailsDisplay" style="font-size: 0.85rem; color: var(--color-text-body);">
                            Bank information from your admin-verified profile will be shown to donors for direct transfer.
                        </div>
                    </div>
                </div>

                <!-- Volunteer Request Specific Fields -->
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const lblItem = document.getElementById("lblReqItemName");

        reqTypeSelect.addEventListener("change", () => {
            const val = reqTypeSelect.value;
            if (val === 'physical') {
                secPhys.style.display = "block";
                secMon.style.display = "none";
                secVol.style.display = "none";
                lblItem.textContent = "Material / Item Needed";
            } else if (val === 'monetary') {
                secPhys.style.display = "none";
                secMon.style.display = "block";
                secVol.style.display = "none";
                lblItem.textContent = "Fundraising Purpose Title";
            } else if (val === 'volunteer') {
                secPhys.style.display = "none";
                secMon.style.display = "none";
                secVol.style.display = "block";
                lblItem.textContent = "Volunteer Activity Title";
            }
        });
    });
</script>
